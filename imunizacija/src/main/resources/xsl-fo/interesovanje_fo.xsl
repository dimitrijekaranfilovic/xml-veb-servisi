		...
		<fo:root>
            ...
            <fo:page-sequence master-reference="interesovanje-page">
            	<fo:flow flow-name="xsl-region-body">
            		<fo:block font-family="Arial" font-size="17px" font-weight="bold" text-align="center">
            			Исказивање интересовања за вакцинисање против COVID-19
            		</fo:block>
            		<fo:block margin-top="5mm" font-family="Arial" font-size="12px" font-weight="bold">
            			Одаберите опцију:
            		</fo:block>
            		<xsl:variable name="x" select="//b:drzavljanstvo"/>
            		<fo:block margin-left="20mm" font-family="Arial" font-size="11px" font-weight="bold">
            		...
            		<fo:block margin-top="5mm" font-family="Arial" font-size="11px" font-weight="bold">
            		...
            		<xsl:for-each select="//b:proizvodjac">
				    	<fo:block margin-left="20mm" margin-top="2mm" font-family="Arial" font-size="11px" font-weight="bold"><xsl:value-of select="text()"/></fo:block>
				    </xsl:for-each>
				    <fo:block margin-top="5mm" font-family="Arial" font-size="11px" font-weight="bold">
            			Да ли сте добровољни давалац крви?
            		</fo:block>
            		<xsl:variable name="x" select="//b:davalac_krvi"/>
            		<fo:block margin-left="20mm" margin-top="2mm" font-family="Arial" font-size="11px" font-weight="bold">
            			Да
            			<xsl:choose>
            		...
            		<fo:block margin-top="25mm" font-family="Arial" font-size="11px" font-weight="bold">
            			дана 
	            	...
	            	<fo:block>
	            		<fo:float float="end">
		            		<fo:block padding-left="20mm" padding-right="20mm" padding-top="2mm" font-family="Arial" font-size="11px" font-weight="bold" border-top="solid" border-top-width="0.2mm">
		            			Потпис
		            		</fo:block>
	            		</fo:float>
            		</fo:block>
