        ...
        <fo:root>
            ...
            <fo:page-sequence master-reference="interesovanje-page">
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <fo:block margin-top="0mm" font-family="SourceSansPro" font-size="11px" font-weight="normal">
                        <xsl:value-of select="//b:jmbg"/>
                    </fo:block>
                    <fo:block margin-top="-3mm">
                        <fo:leader leader-pattern="dots" leader-length="100%" rule-style="solid" rule-thickness="1pt"/>
                    </fo:block>
                    <fo:block margin-top="5mm" font-family="SourceSansPro" font-size="11px" font-weight="normal">
                        Име:
                    </fo:block>
                    ...
                    <xsl:for-each select="//b:proizvodjac">
                        <fo:block margin-left="20mm" margin-top="2mm" font-family="SourceSansPro" font-size="11px"
                                  font-weight="normal">
                    ...
                    <fo:block>
                        <fo:float float="end">
                            <fo:block padding-left="20mm" padding-right="20mm" padding-top="2mm"
                                      ...
                                      border-top="solid" border-top-width="0.2mm">
                                Потпис
                            </fo:block>
                        </fo:float>
                    </fo:block>
