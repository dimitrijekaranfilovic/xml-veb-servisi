            	...
            	<fo:flow flow-name="xsl-region-body">
						...
						<fo:table>
                            ...
                            <fo:table-body>
                            	...
                            	<fo:table-row>
                            		...
                            		<fo:table-cell><fo:block>2)<xsl:value-of select="//b:naziv_drzavljanstva"/></fo:block></fo:table-cell>
                            		<fo:table-cell><fo:block><xsl:value-of select="//b:broj_pasosa"/></fo:block></fo:table-cell>
                            	</fo:table-row>
                            </fo:table-body>
						</fo:table>
					</fo:block>
                            ...
                            <fo:table-body>
                            	<fo:table-row>
                            		<fo:table-cell vertical-align="middle">
                            			...
                            			<fo:block>Изјављујем да: 
                            				<xsl:choose>
										      	<xsl:when test="$x = 'true'">
							                      <fo:inline>САГЛАСАН САМ</fo:inline>
							                    </xsl:when>	
							                    <xsl:when test="$x = 'false'">
							                      <fo:inline>НИСАМ САГЛАСАН</fo:inline>
							                    </xsl:when>	
			                    			</xsl:choose>
	                            			 са спровођењем активне/пасивне имунизације (уписати назив имунолошког лека): <xsl:value-of select="//b:naziv_imunoloskog_leka"/></fo:block>
                            		</fo:table-cell>
                            	</fo:table-row>
                            </fo:table-body>
						</fo:table>
					...
					<fo:block font-family="Arial" font-size="11px" font-weight="bold" margin-top="5mm">
						<fo:table>
                            ...
                            <fo:table-body>
                            	<fo:table-row>
                            		<fo:table-cell vertical-align="middle">
                            			<fo:block>Лекар ми је објаснио предности и ризике од спровођења активне/пасивне имунизације наведеним имунолошким леком.</fo:block>
                            		</fo:table-cell>
                            	</fo:table-row>
                            </fo:table-body>
						</fo:table>
					...
					<fo:block font-family="Arial" font-size="11px" font-weight="bold" margin-top="5mm">
						<fo:table>
                            ...
                            <fo:table-body>
                            	<fo:table-row>
                            		<fo:table-cell vertical-align="middle"><fo:block>Здравствена установа: <xsl:value-of select="//b:naziv"/></fo:block></fo:table-cell>
                            		<fo:table-cell><fo:block>|</fo:block></fo:table-cell>
                            		<fo:table-cell vertical-align="middle"><fo:block>Пункт: <xsl:value-of select="//b:punkt"/></fo:block></fo:table-cell>
                            	</fo:table-row>
                            </fo:table-body>
						</fo:table>
					</fo:block>
					<fo:block font-family="Arial" font-size="11px" font-weight="bold" margin-top="5mm">
						<fo:table>
                            ...
                            <fo:table-body>
                            	<fo:table-row>
                            		<fo:table-cell vertical-align="middle">
                            			<fo:block>Име, презиме, факсимил и бр. телефона лекара: <xsl:value-of select="//b:lekar/za:ime"/>, <xsl:value-of select="//b:lekar/za:prezime"/>, <xsl:value-of select="//b:broj_mobilnog"/></fo:block>
                            		</fo:table-cell>
                            	</fo:table-row>
                            </fo:table-body>
						</fo:table>
					...
					<fo:block font-family="Arial" font-size="10px" font-weight="bold" margin-top="5mm" border="1px">
						<fo:table>
                            ...
                            <fo:table-body>
                            	<fo:table-row border="1px solid darkgrey">
                            		<fo:table-cell><fo:block>Назив вакцине</fo:block></fo:table-cell>
                            		<fo:table-cell><fo:block>Датум давања вакцине</fo:block></fo:table-cell>
                            		<fo:table-cell><fo:block>Начин давања вакцине</fo:block></fo:table-cell>
                            		<fo:table-cell><fo:block>Екстремитет</fo:block></fo:table-cell>
                            		<fo:table-cell><fo:block>Серија вакцине (лот)</fo:block></fo:table-cell>
                            		<fo:table-cell><fo:block>Произвођач</fo:block></fo:table-cell>
                            		<fo:table-cell><fo:block>Нежељена реакција</fo:block></fo:table-cell>
                            		<fo:table-cell><fo:block>Потпис лекара</fo:block></fo:table-cell>
                            	</fo:table-row>
                            	<xsl:for-each select="//b:vakcina">
		                           	<fo:table-row border="1px solid darkgrey">
		                           		<fo:table-cell><fo:block><xsl:value-of select="za:broj_doze"/></fo:block></fo:table-cell>
		                           		<fo:table-cell><fo:block><xsl:value-of select="za:datum_davanja"/></fo:block></fo:table-cell>
		                           		<fo:table-cell><fo:block>ИМ</fo:block></fo:table-cell>
		                           		<fo:table-cell><fo:block>1) ДР, 2) ЛР</fo:block></fo:table-cell>
		                           		<fo:table-cell><fo:block><xsl:value-of select="za:broj_serije"/></fo:block></fo:table-cell>
		                           		<fo:table-cell><fo:block><xsl:value-of select="za:tip"/></fo:block></fo:table-cell>
		                           		<fo:table-cell><fo:block><xsl:value-of select="b:nuspojava"/></fo:block></fo:table-cell>
		                           		<fo:table-cell><fo:block></fo:block></fo:table-cell>
		                           	</fo:table-row>
                            	</xsl:for-each>
                            	<fo:table-row border="1px solid darkgrey">
	                           		<fo:table-cell number-columns-spanned="2"><fo:block>Привремене контраиндикације (датум утврђивања и дијагноза):</fo:block></fo:table-cell>
	                           	...
	                           	<fo:table-row border="1px solid darkgrey">
	                           		<fo:table-cell number-columns-spanned="2"><fo:block>Одлука комисије за трајне контраиндикације (ако постоји, уписати Да): </fo:block></fo:table-cell>
	                           		<fo:table-cell number-columns-spanned="6"><fo:block>
