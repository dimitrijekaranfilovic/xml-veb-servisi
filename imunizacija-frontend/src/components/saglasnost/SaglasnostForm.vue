    ...
    <v-row justify="center">
      <v-col lg="8" md="12">
        <v-form ref="form" v-model="valid">
          <v-row>
            <h3 class="mt-8 ml-4">Држављанин републике Србије:</h3>
            ...
            <v-col>
              <v-text-field
                ...
                required
                :disabled="
                  brojPasosa !== '' || nazivStranogDrzavljanstva !== ''
                "
              ></v-text-field>
            </v-col>
          </v-row>
  ...
  methods: {
    submit() {
      ...
      response
        ...
        .catch((err) => {
          that.text =
            "Подношење документа није успело. Прво морате поднети интересовање и добити термин за вакцинацију.";
          that.snackbar = true;
        });
    },
    clearZanimanje() {
