      ...
      <body>
        ...
        <table>
          <tr>
            ...
            <td class="left"><xsl:value-of select="//b:broj_sertifikata" /></td>
            ...
            <td class="right"><xsl:value-of select="//b:datum_vreme_izdavanja" /></td>
          </tr>
        </table>
        <table class="b-b">
          <tr>
          ...
          <tr>
            ...
            <td width="60%" class="left"><xsl:value-of select="//za:jmbg" /></td>
          </tr>
          <tr>
            <td class="left"><b>Број пасоша / Passport No.:</b></td>
            <td width="60%" class="left"><xsl:value-of select="//b:broj_pasosa" /></td>
          </tr>
        </table>
        <table>
          <caption>
          ...
          <tr>
            <td class="b-r">
              <table class="left">
                ...
                <tr>
                  <td>
                    <b>Здравствена установа / Health cate institution:</b>
                  </td>
                </tr>
                <tr>
                  <td>Novi Sad</td>
        ...
        <table class="b-t">
          <thead class="b-b">
            <tr>
              <th class="b-r">SARS-CoV-2 RT</th>
              <th class="b-r">SARS-CoV-2 Ag-RDT</th>
              <th>SARS-CoV-2 RBD S-Protein</th>
            </tr>
            <tr>
              <th class="b-r">Real-time PCR</th>
              <th class="b-r">(Antigen Rapid Detection test)</th>
              <th>Immunoglobulin G (IgG) test</th>
            </tr>
          </thead>
          <tbody class="left">
            <tr>
              <td class="bold b-r">Врста узорка / Sample type:</td>
              <td class="bold b-r">Врста узорка / Sample type:</td>
              <td class="bold">Врста узорка / Sample type:</td>
            </tr>
            <tr>
              <td class="b-r">N/A</td>
              <td class="b-r">N/A</td>
            ...
            <tr>
              <td class="bold b-r">Произвођач теста / Test manufacturer:</td>
              <td class="bold b-r">Произвођач теста / Test manufacturer:</td>
              <td class="bold">Произвођач теста / Test manufacturer:</td>
            </tr>
            <tr>
              <td class="b-r">N/A</td>
              <td class="b-r">N/A</td>
            ...
            <tr>
              <td class="bold b-r">
                Датум и време узорковања /<br /> Date and time of sampling:
              </td>
              <td class="bold b-r">
                  Датум и време узорковања /<br /> Date and time of sampling:
              </td>
            ...
            <tr>
              <td class="bold b-r">
                Датум и време издавања резултата /<br /> Date and time of
                results:
              </td>
              <td class="bold b-r">
                  Датум и време издавања резултата /<br /> Date and time of
            ...
            <tr class="gray-bg b-t">
              <td class="bold">Резултат / Result:</td>
              <td class="bold">Резултат / Result:</td>
              <td class="bold">Резултат / Result:</td>
            </tr>
            <tr class="gray-bg">
            ...
            <tr class="gray-bg">
              <td class="bold">Лабораторија / Laboratory:</td>
              <td class="bold">Лабораторија / Laboratory:</td>
              <td class="bold">Лабораторија / Laboratory:</td>
            </tr>
            <tr class="gray-bg">
              ...
              <table>
                <tr>
                  <td width="20%">
                    <img
                      class="footer-img"
                      src="https://euprava.gov.rs/media/logos/Batut.gif"
                    />
                  </td>
                  <td width="80%" class="left">
                    <b>Сертификат издаје:</b><br /> Институт за јавно здравље
                    Србије<br /> "Др Милан Јовановић Батут"<br />
                    <b>Certificate issued by:</b><br /> Intitute of Public
                    Health of Serbia<br />
